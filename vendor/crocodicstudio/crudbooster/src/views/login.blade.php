...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="{{ CRUDBooster::getSetting('favicon')?asset(CRUDBooster::getSetting('favicon')):asset('vendor/crudbooster/assets/sumberbola.png') }}">
    ...
    <body class="login-page">
        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="{{url('/')}}">
                    <img title='{!!(CRUDBooster::getSetting('appname') == 'CRUDBooster')?"<b>CRUD</b>Booster":CRUDBooster::getSetting('appname')!!}' src='{{ CRUDBooster::getSetting("logo")?asset(CRUDBooster::getSetting('logo')):asset('vendor/crudbooster/assets/logo24.png') }}' style='max-width: 100%;max-height:170px'/>
                </a>
            </div><!-- /.login-logo -->      
