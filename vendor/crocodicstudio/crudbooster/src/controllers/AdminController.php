...
class AdminController extends CBController {
    ...
    public function postLogin() {
        ...
        if($users->id_cms_privileges != 1){
            CRUDBooster::insertLog(trans("crudbooster.log_logout", ['email' => $email]) . ' - Akses admin ditolak');
            
            return redirect('/login')->with('info', 'Silahkan login disini!');
        }
