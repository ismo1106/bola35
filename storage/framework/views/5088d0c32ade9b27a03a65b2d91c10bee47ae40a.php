   ...
   <?php if($index_statistic): ?>
    ...
    <div class="box box-default">
      <div class="box-body table-responsive no-padding">
        <table class='table table-bordered'>
          <tbody>
            <tr class='active'>
              <td colspan="2"><strong><i class='fa fa-bars'></i> <?php echo e(ucwords(str_replace('_',' ',g('parent_table')))); ?></strong></td>
            </tr>
    ...
    <div class="box">
      <div class="box-header">  
        ...
        <div class="box-tools pull-<?php echo e(trans('crudbooster.right')); ?>" style="padding-top:5px">
          
              <?php if($button_filter): ?>
              <a style="margin-top:-23px" href="javascript:void(0)" id='btn_advanced_filter' data-url-parameter='<?php echo e($build_query); ?>' title='Advanced Filter Data' class="btn btn-sm btn-default <?php echo e((Request::get('filter_column'))?'active':''); ?>">                               
            ...
            <form method='get' style="display:inline-block;width: 260px;" action='<?php echo e(Request::url()); ?>'>
                <div class="input-group">
                  <input type="text" name="q" value="<?php echo e(Request::get('q')); ?>" class="form-control input-sm pull-<?php echo e(trans('crudbooster.right')); ?>" placeholder="Search"/>
                  ...
                  <div class="input-group-btn">
                    ...
                    ?>
                    <button type='button' onclick='location.href="<?php echo e(CRUDBooster::mainpath().$build_query); ?>"' title='Reset' class='btn btn-sm btn-warning'><i class='fa fa-ban'></i></button>
                    <?php endif; ?>
