	...
	<script type="text/javascript">
		$(function() {			
			$('#<?php echo e($form['parent_select']); ?>').change(function() {
				var $current = $("#<?php echo e($form['name']); ?>");
				var parent_id = $(this).val();
				var fk_name = "<?php echo e($form['parent_select']); ?>";
				...
				if(fk_value!='') {					
					...
					$.get("<?php echo e(CRUDBooster::mainpath('data-table')); ?>?table="+table+"&label="+label+"&fk_name="+fk_name+"&fk_value="+fk_value,function(response) {
						if(response) {
							$current.html("<option value=''><?php echo e(trans('crudbooster.text_prefix_option')); ?> <?php echo e($form['label']); ?>");
			...
			<?php if($value): ?>
				$('#<?php echo e($form['parent_select']); ?>').trigger('change');
