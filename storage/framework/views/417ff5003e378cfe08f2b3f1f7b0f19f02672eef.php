...
<ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo e(CRUDBooster::mainpath('screet-key')); ?>"><i class='fa fa-key'></i> API Screet Key</a></li>
...
<table id='table-apikey' class='table table-striped table-bordered'>
	...
	<tbody>
		<?php $no = 0;?>
		<?php $__currentLoopData = $apikeys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
		<tr>
			<td><?php echo e(++$no); ?></td>
